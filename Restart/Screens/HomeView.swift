    ...
    var body: some View {
        ...
        VStack(spacing:20) {
           Spacer()
            ...
            Text("The time that leads to mastery is dependend on the intensity of our focus.").font(.title3).fontWeight(.light).foregroundColor(.secondary).multilineTextAlignment(.center).padding()
            Spacer()
            Button(action:{
